  ...
  return (
    <main className="min-h-screen bg-blue-50 text-gray-900 flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-16">
        <Card className="w-full max-w-md border-gray-200 shadow-lg rounded-xl bg-white">
          <CardHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  required
                  className="mt-1 border-gray-300 focus:ring-blue-400 focus:border-blue-400"
                />
              </div>
              ...
              <Button
                type="submit"
                className="w-full bg-blue-600 text-white hover:bg-blue-700 focus:ring-blue-400 font-semibold py-3 rounded-lg"
                disabled={isLoading}
              >
