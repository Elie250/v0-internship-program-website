      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex gap-8">
            ...
            <Link href="/about" className="hover:text-blue-400 transition text-sm">About</Link>
            ...
            <Link href="/contact" className="hover:text-blue-400 transition text-sm">Contact</Link>
          </div>
        ...
        <div className="md:hidden flex flex-wrap gap-2 pb-4">
          ...
          <Link href="/about" className="text-xs hover:text-blue-400 transition">About</Link>
          ...
          <Link href="/contact" className="text-xs hover:text-blue-400 transition">Contact</Link>
        </div>
      </div>
    </nav>
  );
