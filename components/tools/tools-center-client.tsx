...
/** Client body for /tools — shell is a Server Component. */
export function ToolsCenterClient() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-12 app-form-surface">
      <ToolsCenterHub calculatorsHref="/tools/calculators" brainHref="/tools/brain-training" />
